    ...
    <Container fixed sx={{ padding: '200px auto', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: '30px' }}>
      ...
      <Grid container sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} >
        <Grid item xs='12' md='6' >
          {Data.map((item, index) =>
            <Box key={index} color='#FFD76D99' flexDirection='row' sx={{ display: 'flex', alignItems: 'center', alignContent: 'flex-start', gap: '20px', margin: '30px', }}>
        ...
        <Grid item xs='12' md='6' sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }} >
          <img src={require("../../assets/whatI/Rectangle 2 (1).png")} alt='' style={{ width: '60%', height: '515px' }} />
          <Typography variant='h2' color='#FFD76D' textAlign='center' sx={{ margin: '20px' }}>
            Raina Ahluwalia
          </Typography>
        </Grid>
      </Grid>
