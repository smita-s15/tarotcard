    ...
    return (
        <form action="">
            ...
            <Box sx={{display:'flex', flexDirection:{xs:'column', md:'row'} , gap:'30px'}}>
                <Button size="large" variant="outlined" style={{ textTransform: 'inherit' }} sx={{ borderColor: '#FFD76D', color: '#FFD76D',  width: { xs: '100%', md: '150px' } }} >
                    Back
                </Button>
                <Button size="large" variant="contained" style={{ textTransform: 'inherit' }} sx={{ bgcolor: '#FFD76D', color: 'black',  width: { xs: '100%', md: '150px' } }} >
                    Done
                </Button>
            </Box>
            <br /><br />
